...
<#if layoutType == "type1">
import devs.paolorotolo.appintro.${activityClassSuper1};
import devs.paolorotolo.appintro.${appIntroFragment1};
</#if>
<#if layoutType == "type2">
import devs.paolorotolo.appintro.${activityClassSuper2};
import devs.paolorotolo.appintro.${appIntroFragment2};
</#if>

// Add in your root build.gradle at the end of repositories:
// maven { url 'https://jitpack.io' }
<#if layoutType == "type1">
public class ${className} extends AppIntro {
</#if>
<#if layoutType == "type2">
